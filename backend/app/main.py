...
from app.api.v1 import knowledge, document, chat, agent, shortcut, llm_provider, graph_api, vector_status
...
app.include_router(graph_api.router, prefix=settings.API_PREFIX, tags=["Knowledge Graph"])
app.include_router(vector_status.router, prefix=settings.API_PREFIX, tags=["Vector Status"])
